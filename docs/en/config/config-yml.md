...
| `dsn` | string | `./db/nexacard.db` | Database connection string | Configure according to environment |
...
| `bot_username` | string | Bot username (without `@`) | e.g. `nexacard_login_bot` |
